...
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-sshremote.static.compile.info
cmdX xyo-cc --mode=$ACTION @util/quantum-script-extension-sshremote.dynamic.compile.info
